<?php
class ShowPostIds_List extends WP_List_Table {
	...
	public static function get_posts( $per_page = 5, $page_number = 1 ) {
		...
		$sql = "SELECT ID, post_title FROM {$wpdb->prefix}posts WHERE post_status = 'publish' AND post_type = 'post'";
	...
	public static function record_count() {
		...
		$sql = "SELECT COUNT(*) FROM {$wpdb->prefix}posts WHERE post_status = 'publish' AND post_type = 'post'";
